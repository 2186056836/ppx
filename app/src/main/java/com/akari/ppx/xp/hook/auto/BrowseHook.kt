...
class BrowseHook : BaseHook {
    override fun onHook() {
        ...
        isDelayHandoff.check(true) {
            ...
            videoHolderClass.hookAfterMethod("k_", Int::class.java) { param ->
                val feedCell = param.thisObject.getObjectFieldOrNull("h")
                    ?: return@hookAfterMethod
                if (feedCell.callMethodOrNullAs<Int>("getCellType") == 1 && 5 == param.args[0] as Int)
